            ...
            <div class="cart-header">
                ...
                <div class="cart-sec simpleCart_shelfItem">
                    ...
                    <div class="cart-item cyc">
                        <img src="/saleDetail/showImage?imgName=${goodsInfo.fileName}" class="img-responsive" style="width: 300px;height: 200px"/>
                    </div>
                    <div class="cart-item-info">
                        <h3><a href="/saleDetail/viewProductDetails?goodsId=${goodsInfo.goodsId}&userId=${sessionScope.userInfo.userId}">商品名称 ：${goodsInfo.goodsName}</a>
                            <span>
                                类型 :
