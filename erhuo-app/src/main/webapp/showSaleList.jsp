    ...
    <div class="header-bottom">
        ...
        <div class="top-nav">
            <ul class="memenu skyblue">
                ...
                <li class="grid"><a href="/shoppingCart/shoppingCartPage?userId=${sessionScope.userInfo.userId}">我的购物车</a>
                </li>
                <li class="grid"><a href="typo.html">关于</a></li>
            </ul>
        </div>
        ...
        <form class="form-inline" role="form" id="tf" action="/saleList/indexQueryGoods" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2  col-sm-offset-6">
                    <input type="button" class="btn btn-primary" value="搜索" id="searchBtn"/>
                </div>
            </div>
            <div class="form-group">
