...
<div class="container">
    ...
    <div class="address-box" style="margin-top: 10px">
        ...
        <div style="padding-left: 50px">
            <span>收货地址:</span>
            <input type="text" id="orderReceiveAddress" name="orderReceiveAddress" value="${sessionScope.userInfo.userAddress}" style="width: 300px" placeholder="收货地址">
            <span>收件人:</span>
            <input type="text" id="orderReceiveName" name="orderReceiveName" value="${sessionScope.userInfo.userName}" placeholder="收件人姓名">
            <span>联系方式:</span>
            <input type="text" id="orderReceivePhone" name="orderReceivePhone" value="${sessionScope.userInfo.userPhone}" placeholder="联系方式">
            <%--购买者编号--%>
